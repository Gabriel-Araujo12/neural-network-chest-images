...
### Modelos Criados
O primeiro modelo criado foi uma Rede Neural Perceptron Multicamadas (MLP) e o segundo foi uma Rede Neural Convolucional (CNN), sendo assim, é recomendado começar a visualização pelo modelo MLP.
